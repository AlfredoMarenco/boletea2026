        ...
        while (($row = fgetcsv($handle)) !== false) {
            ...
            $batch[] = [
                ...
                'metadata' => json_encode([
                    'owner' => mb_convert_encoding($row[1] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'details' => mb_convert_encoding($row[2] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'row' => mb_convert_encoding($row[4] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'seat' => mb_convert_encoding($row[5] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'price' => mb_convert_encoding($row[6] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'order_id' => mb_convert_encoding($row[7] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'source' => mb_convert_encoding($row[8] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
                    'external_event_id' => mb_convert_encoding($row[9] ?? '', 'UTF-8', 'UTF-8, ISO-8859-1'),
