                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-500 dark:text-muted-foreground">
                            La plataforma líder en venta de boletos para tus
                            eventos favoritos. Seguridad, rapidez y confianza.
                        </p>
                        <div className="flex gap-4">
                            <a
                                href="#"
                                className="text-gray-400 transition-colors hover:text-[#c90000]"
                            >
                    ...
                    <div>
                        ...
                        <p className="mb-4 text-sm text-gray-500 dark:text-muted-foreground">
                            Suscríbete para recibir noticias, promociones y
                        ...
                        <form className="flex gap-2">
                            <input
                                ...
                                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-400 focus:border-[#c90000] focus:ring-1 focus:ring-[#c90000] focus:outline-none dark:border-border dark:bg-card dark:text-white"
                            />
                            <button
                                type="button"
            ...
            <div className="border-t border-gray-100 bg-gray-50 py-6 dark:border-border dark:bg-card">
                <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-6 md:flex-row">
                    <p className="text-xs text-gray-500 dark:text-muted-foreground">
                        &copy; {currentYear} Boletea. Todos los derechos
                        reservados.
                    </p>
