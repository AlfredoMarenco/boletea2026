...
export default function PublicFooter() {
    ...
    return (
        <footer className="bg-white dark:bg-[#050505] border-t border-gray-100 dark:border-border pt-16 pb-8 font-sans">
            <div className="container mx-auto px-6">
                    ...
                    <div>
                        ...
                        <form className="flex gap-2 mb-8" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="bg-gray-50 dark:bg-card border border-gray-200 dark:border-border rounded-lg px-4 py-2.5 text-sm w-full focus:outline-none focus:ring-2 focus:ring-[#c90000]/50 transition-all dark:text-white"
                            />
                ...
                <div className="border-t border-gray-100 dark:border-border pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
...
function SocialLink({ href, icon: Icon }: { href: string, icon: any }) {
    return (
        <a
            ...
            className="w-10 h-10 rounded-full flex items-center justify-center bg-gray-50 dark:bg-card text-gray-600 dark:text-muted-foreground hover:bg-[#c90000] hover:text-white transition-all duration-300"
        >
