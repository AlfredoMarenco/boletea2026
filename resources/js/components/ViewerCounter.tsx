...
export default function ViewerCounter({ eventId }: Props) {
    ...
    if (!isVisible) return <div className="mt-4 h-10" />; // Placeholder for layout stability

    return (
        <div className="flex animate-in items-center gap-3 rounded-xl border border-red-100/50 bg-red-50/50 px-3 py-1.5 transition-all duration-700 fade-in slide-in-from-bottom-2 dark:border-red-500/10 dark:bg-red-500/5">
            {/* Live Indicator */}
            ...
            <div className="flex items-center gap-2">
                <Users className="size-4 shrink-0 text-red-600/70 dark:text-red-500/70" />
                <p className="text-xs font-bold whitespace-nowrap text-gray-700 dark:text-gray-300">
