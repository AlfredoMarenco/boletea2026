...
import { Info, MapPin, Image as ImageIcon, CreditCard, Link as LinkIcon, Save, X } from 'lucide-react';
...
export default function Create({ salesCenters = [], salesCenterGroups = [], states = [], cities = [], categories = [], venues = [], allEvents = [] }: Props) {
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="relative">
                                                    ...
                                                    <Button 
                                                        ...
                                                        onClick={() => document.getElementById('create-main-image-upload')?.click()}
                                                    >
                                                        <ImageIcon className="size-4" />
                                                        Subir Local
                                                    </Button>
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="relative">
                                                    ...
                                                    <Button 
                                                        ...
                                                        variant="outline" 
                                                        className="w-full rounded-xl gap-2 h-11 border-dashed hover:border-[#c90000] hover:bg-red-50 dark:hover:bg-red-900/10"
                                                        onClick={() => document.getElementById('create-secondary-image-upload')?.click()}
                                                    >
                                                        <ImageIcon className="size-4" />
                                                        Subir Local
                                                    </Button>
                            ...
                            <div className="bg-white dark:bg-[#1a1c20] p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
                                <div>
                                    ...
                                    <div className="p-8 border-2 border-dashed rounded-2xl text-center text-gray-400">
                                        Guarda el evento primero para sincronizar precios desde la API de Boletea.
                                    </div>
                                </div>
                        ...
                        <TabsContent value="linking" className="space-y-6">
                            <div className="bg-white dark:bg-[#1a1c20] p-6 rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm space-y-10">
                                ...
                                <div className="pt-8 border-t dark:border-white/5">
                                    ...
                                    <div className="flex items-center space-x-4 p-5 rounded-2xl border-2 border-[#c90000]/20 bg-[#c90000]/5 mb-8">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Oculta el sidebar y habilita la vista de cuadrícula para los eventos vinculados.</p>
                                        </div>
                                    </div>
                                            ...
                                            <div className="border rounded-2xl overflow-hidden bg-gray-50 dark:bg-card">
                                                ...
                                                <div className="h-72 overflow-y-auto">
                                                    {filteredEvents.map(ev => (
                                                        <div key={ev.id} onClick={() => setData('linked_events', [...(data.linked_events || []), ev.id])} className="p-4 border-b dark:border-white/5 hover:bg-white dark:hover:bg-white/10 cursor-pointer flex flex-col gap-1 transition-all group">
                                ...
                                <div className="pt-8 border-t dark:border-white/5">
                                    ...
                                    {!data.show_calendar && (
                                        <div className="p-8 border border-dashed rounded-2xl text-center text-gray-400 bg-gray-50 dark:bg-card">
                                            Guarda el evento y sincroniza las funciones para personalizar los botones.
                                        </div>
                                    )}
                                </div>
                            </div>
