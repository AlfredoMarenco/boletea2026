...
export default function Edit({ banner, events }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        _method: 'put',
        title: banner.title || '',
        type: banner.type || 'manual',
        image_file: null as File | null,
        external_link: banner.external_link || '',
        external_event_id: banner.external_event_id ? banner.external_event_id.toString() : '',
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Editar Banner', href: route('admin.banners.edit', banner.id) }
        ]}>
            <Head title="Editar Banner" />

            <div className="p-6 max-w-4xl mx-auto">
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Editar Banner Flotante</h1>
                                ...
                                {data.type === 'manual' && (
                                    <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                                        <div>
                                            ...
                                            {banner.image_path && !data.image_file && banner.type === 'manual' && (
                                                <div className="mb-3">
                                                    <img src={banner.image_path} alt="Banner actual" className="h-32 object-contain rounded-md border border-gray-200" />
                                                    <p className="text-xs text-gray-500 mt-1">Imagen actual. Sube una nueva si deseas reemplazarla.</p>
                                                </div>
                                            )}
